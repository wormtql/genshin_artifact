...
use crate::artifacts::effect_config::{ArtifactEffectConfig, ConfigPaleFlame, ConfigRate};
use crate::attribute::SimpleAttributeGraph2;
use crate::character::{Character, CharacterName};
use crate::character::character_common_data::CharacterCommonData;
use crate::character::characters::razor::Razor;
...
impl TargetFunction for RazorDefaultTargetFunction {
    ...
    fn get_default_artifact_config(&self, team_config: &TeamQuantization) -> ArtifactEffectConfig {
        ArtifactEffectConfig {
            ...
            config_pale_flame: ConfigPaleFlame {
                avg_level: 1.0,
                full_rate: 0.1
            },
