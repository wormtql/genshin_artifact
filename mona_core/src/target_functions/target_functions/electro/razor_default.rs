...
use crate::artifacts::effect_config::{ArtifactEffectConfig, ArtifactEffectConfigBuilder, ConfigPaleFlame, ConfigRate};
use crate::attribute::SimpleAttributeGraph2;
use crate::character::{Character, CharacterName};
use crate::character::character_common_data::CharacterCommonData;
use crate::character::characters::electro::razor::Razor;
...
pub struct RazorDefaultTargetFunction;

impl TargetFunctionMetaTrait for RazorDefaultTargetFunction {
    ...
    fn create(_character: &CharacterCommonData, _weapon: &WeaponCommonData, _config: &TargetFunctionConfig) -> Box<dyn TargetFunction> {
        Box::new(RazorDefaultTargetFunction)
    }
}

impl TargetFunction for RazorDefaultTargetFunction {
