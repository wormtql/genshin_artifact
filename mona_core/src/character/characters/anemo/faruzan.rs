...
pub const FARUZAN_SKILL: FaruzanSkillType=  FaruzanSkillType {
    ...
    q_dmg: [2.136,2.2962,2.4564,2.67,2.8302,2.9904,3.204,3.4176,3.6312,3.8448,4.0584,4.272,4.539,4.806,5.073],
    q_bonus: [0.237,0.2548,0.2726,0.2963,0.3141,0.3319,0.3556,0.3793,0.403,0.4267,0.4504,0.4741,0.5037,0.5333,0.563],
};
